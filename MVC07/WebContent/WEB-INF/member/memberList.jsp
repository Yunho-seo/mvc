	...
	function deleteFn(num){
  	...
  	function memberList() {
  		...
  		$.ajax({
  			...
  			type : "get",
  			dataType : "json",
  			success : resultHtml,  // 서버의 응답을 받는 콜백 함수 
  			// (회원 리스트로 받기) : json array 형식 ([{  }, {  }, {  }])
  	...
  	function resultHtml(data) {
	    ...
	    html+="</tr>";
  		...
  		// 반복문 처리 - [{  }, {  }, {  }]
  		// data는 json배열 { }에 해당하는 객체를 하나 빼내어 obj에 넘겨준다
  		// 여러 데이터를 index로 놓는것임 / {  }, {  }, {  }는 각각 0, 1, 2번 index data
    ...
    <div class="panel-body">
    	<div class="table-responsive">          
    		...
    		<tbody>
			  ...
			  <tr>
			  <td colspan="8" align="left"><input type="button" value="회원가입" class="btn btn-primary" onclick="location.href='${ctx}/memberRegister.do'"/></td>
			  </tr>
		    </tbody>
		  	</table>
		  </div>
